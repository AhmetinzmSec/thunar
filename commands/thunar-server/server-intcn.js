...
exports.run = (client, message, args) => {
    ...
    if (args[0] === "ayarla" || args[0] == "set") {
        ...
        db.set("intcn" + message.guild.id, channel.id)
    ...
    if (args[0] === "sil" || args[0] == "delete") {
        ...
        if (!db.has("intcn" + message.guild.id)) return message.channel.send("Sistem zaten kapalı")

        db.delete("intcn" + message.guild.id)
