...
module.exports = guild => {
    ...
    const emmmmbed = new Discord.MessageEmbed()
        ...
        .addField(`Thunar Hakkında Ufak Bilgilendirme`, `Thunar'nın sunucunuzda sorunsuz çalışmasını istiyorsanız **Sunucu Ayarları > Roller** kısmından **Thunar** rolünü en üste taşımalısınız. Eğer Thunar rolünü göremiyorsanız botu sunucunuzdan atıp yeniden davet edin ve **Yönetici** yetkisi verdiğinzden emin olun.`)
        .addField(`Thunar Nasıl Kullanılır?`, `**${prefixx}yardım** Yazarak Thunar'ın Yardım Menüsüne Ulaşabilir, Komutlar, Geliştiricim ve Bot Hakkında Detaylı Bilgilere Sahip Olabilirsiniz`)
